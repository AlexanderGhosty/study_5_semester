"""
Модуль для работы с заказами и корзиной покупок.

Содержит функции для управления товарами в корзине:
- Создание корзины из списка товаров
- Индексирование товаров по SKU
- Изменение количества товаров в заказе
- Создание новых товаров
- Финальный расчет стоимости заказа

Функции:
    - build_cart: создание корзины с товарами по 1 шт
    - index_by_sku: создание словаря SKU -> Item
    - change_line_qty: изменение количества в строке заказа
    - create_item: создание нового товара
    - checkout: финальный расчет с промокодом
"""
